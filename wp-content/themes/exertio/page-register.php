						...
						<form id="signup-form">
							<div class="fr-sign-form">
							  ...
							  <div class="fr-sign-form">
							   ...
							   <div class="fr-sign-form">
								<div class="fr-sign-logo"> <img src="<?php echo get_template_directory_uri(); ?>/images/icons/cellphone.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>" class="img-fluid"> </div>
								<div class="form-group">
								  <input type="number"  name="fl_cell_number" placeholder="<?php echo esc_attr__('Email address','exertio_theme'); ?>" class="form-control" required data-smk-msg="<?php echo esc_attr__('Cell Number is required','exertio_theme'); ?>">
								</div>
							  </div>
							  <div class="fr-sign-form">
							  ...
							  <div class="fr-sign-form">
							   ...
							   <div class="fr-sign-form">
								<div class="fr-sign-logo"> <img src="<?php echo get_template_directory_uri(); ?>/images/icons/countries.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>" class="img-fluid"> </div>
								<div class="form-group">
								  <select name="freelancer_locations" id="freelancer_locations" class="form-control country-select">
									<option value="" class="select-country-option"><?php echo  __('Select a Country');?></option>
							     <?php
								...
								<div class="fr-sign-logo"> <img src="<?php echo get_template_directory_uri(); ?>/images/icons/countries.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>" class="img-fluid"> </div>
								 <div class="form-group">
									    <select id="providerType" name="providerType" class="form-control provider-type">
									        ...
									        <option value="non-medical"><?php echo __('Non-Medical');?></option>
									        <option value="nurse">Nurse</option>
									        <option value="mid-level-practitioner"><?php echo __('Mid-level Practitioner');?></option>
									        <option value="medical-physician"><?php echo __('Medical Physician');?></option>
									        <option value="other-medical-provider"><?php echo __('Other Medical Provider');?></option>
									    </select>
								</div>
								</div>
