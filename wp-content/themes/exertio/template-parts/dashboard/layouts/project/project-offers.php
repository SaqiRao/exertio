...
$query = "SELECT * FROM ".$table." WHERE `author_id` = " . $current_user_id;
      ...
      <div class="card mb-4">
        <div class="card-body">
          <div class="pro-section">
            <div class="pro-box heading-row">
              ...
              <div class="pro-coulmn"><?php echo esc_html__( 'Cost / Delivery', 'exertio_theme' ) ?> </div>
               <div class="pro-coulmn"><?php echo esc_html__( 'Freelancer', 'exertio_theme' ) ?> </div>
          ...
          <div class="pro-coulmn offer-freelancer">   
				  	...
				  	<?php
                        if($result->offer_Status == "1") {
                         ...
                         $offer_Status   =   esc_html__('Accepted','exertio_theme');
                         	...
                         	$offer_Status   =   esc_html__('Cancelled by you','exertio_theme');
                         }
				  	 ?>
				  ...
				  <div class="pro-coulmn">
					<span class="pro-btns">
                <?php if($result->offer_Status == "4" || $result->offer_Status == "2" || $result->offer_Status == "3" ){?>
                          <a href="javascript:void(0)" class="btn btn-inverse-danger btn-sm" data-pid="<?php echo esc_attr($result->id ); ?>" data-status="remove" disabled> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Cancel', 'exertio_theme' ); ?></a>           
              <?php } 
               else { ?>
                 <a href="javascript:void(0)" class="btn btn-inverse-danger btn-sm" data-pid="<?php echo esc_attr($result->id ); ?>" data-status="remove"> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Cancel', 'exertio_theme' ); ?></a> 
