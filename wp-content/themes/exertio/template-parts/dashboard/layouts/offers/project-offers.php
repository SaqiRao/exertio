      ...
      <div class="card mb-4">
        <div class="card-body">
          ...
          <div class="pro-coulmn offer-freelancer">   
				  ...
				  <div class="pro-coulmn">
					<span class="pro-btns">
                <?php if($result->offer_Status == "1"){?>
                          <a href="javascript:void(0)" class="btn btn-inverse-danger btn-sm change-offer-status" data-pid="<?php echo esc_attr($result->project_id ); ?>" data-status="remove" data-offer-id = "<?php echo esc_attr($result->id); ?>"> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Cancel', 'exertio_theme' ); ?></a>           
              <?php } 
              ?>
