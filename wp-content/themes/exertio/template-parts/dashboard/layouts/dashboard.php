			...
			<div class="row">		
				...
				<div class="col-md-6 col-lg-6 col-xl-3">
					<div class="info-boxes">
						...
						<p class="matric-bottom"> <a href="<?php echo esc_url(get_the_permalink());?>?ext=completed-projects"><?php echo esc_html__('View Detail', 'exertio_theme' ); ?> <i class="fas fa-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		</div>
				  ...
				  <div class="pro-section">
					  <div class="pro-box heading-row">
						...
						<?php
							...
							$query = "SELECT * FROM ".$table." WHERE `author_id` = '20' ORDER BY updated_on DESC LIMIT 15";
				...
				<div class="card-body">
				  <h4 class="card-title"><?php echo esc_html__('Current Plan Detail', 'exertio_theme' ); ?></h4>
					...
					<?php
                       ...
                       $employer_listing_bump = get_post_meta( $employer_id, '_employer_listing_bump', true);


                       $employer_listing_bump = isset( $employer_listing_bump) && $employer_listing_bump == -1 ? esc_html__(' Unlimited ', 'exertio_theme' ) : $employer_listing_bump;
					...
					if(isset($simple_project) && $simple_project != '')
					{
						...
						<ul>
							...
							<li><img src="<?php echo get_template_directory_uri(); ?>/images/dashboard/success.png" alt="<?php echo esc_attr(get_post_meta($img_id, '_wp_attachment_image_alt', TRUE)); ?>"> <?php echo '<span>'.esc_html__('Project Bump up: ', 'exertio_theme' ).'</span>'.esc_html($employer_listing_bump); ?> </li>
