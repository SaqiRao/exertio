      ...
      <div class="card mb-4">
        <div class="card-body">
          <div class="pro-section">
            ...
            <a href="javascript:void(0)" class="btn btn-inverse-primary btn-sm bump_up_service" data-pid="<?php echo esc_attr($sid); ?>" data-status="bump_up"> <i class="far fa-times-circle"></i> <?php echo esc_html__( 'Bump Up', 'exertio_theme' ); ?></a> 
          </span>
