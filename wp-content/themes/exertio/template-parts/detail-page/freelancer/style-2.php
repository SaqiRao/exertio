                ...
                <div class="fr-hero-m-deails">
                  <ul>
                    ...
                    <?php if (intval(get_post_meta($fl_id, 'exertio_freelancer_total_views', true) != "")) { ?>
                      <li><span><i class="far fa-eye" style="margin-right: 5px;"></i><?php echo wp_sprintf(esc_html__('%s Views', 'exertio_theme'), number_format(get_post_meta($fl_id, 'exertio_freelancer_total_views', true))); ?></span> </li>
                    <?php }


                        $fl_portfolio = get_post_meta($fl_id, '_freelancer_portfolio_link', true);

        if(isset($exertio_theme_options['fl_portfolio']) && $exertio_theme_options['fl_portfolio'] == 2 && $fl_portfolio != "")
        {

          ?>
         <li><span> <a href="<?php echo esc_url( $fl_portfolio); ?>" class="fl_portfolio"><?php echo esc_html__( 'Portfolio', 'exertio_theme' ); ?></a></span></li>
          <?php
        }
