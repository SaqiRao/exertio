...
if(isset($active_profile)  && $active_profile == 1)
{
	if(isset($_GET['ext']) && $_GET['ext'] !="")
	{
		...
		else if($page_type == "emp-meeting-manage")
		{
			get_template_part('template-parts/dashboard/layouts-2/project/emp-meeting-manage');
		}
...
else if(isset($active_profile)  && $active_profile == 2)
{
	if(isset($_GET['ext']) && $_GET['ext'] !="")
	{
		...
		else if($page_type == "define-availlibity")
		{

			get_template_part('template-parts/dashboard/layouts-2/project/define-availlibity');
		}
		else if($page_type == "meeting-manage")
		{

        get_template_part('template-parts/dashboard/layouts-2/project/meeting-manage');
		}
		else if($page_type == "booking-send")
		{

        get_template_part('template-parts/dashboard/layouts-2/project/booking-send');
		}
		else
		{
			get_template_part( 'template-parts/dashboard/layouts-2/dashboard');	
