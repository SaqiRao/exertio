...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
	...
	<?php
		  ...
		  $menu_options_array   =  $exertio_theme_options['freelancer_dashboard_sidebar_sortable'];
		...
		foreach($menu_options_array_new as $key => $val)
		{
			...
			{
				?>
				<li class="nav-item <?php if($page_name == 'meeting-manage') { echo 'active';} ?>">
					<a class="nav-link" data-toggle="collapse" href="#meetings-calender" aria-expanded="false" aria-controls="meetings-calender">
					  <i class="fas fa-user menu-icon"></i>
					  <span class="menu-title"><?php echo esc_html($val); ?></span>
					  <i class="fas fa-chevron-down menu-arrow"></i>
					</a>
				<div class="collapse <?php if($page_name == 'define-availibity' || $page_name == 'meeting-manage' ){ echo 'show';} ?>" id="meetings-calender">
					  <ul class="nav flex-column sub-menu">
						<li class="nav-item <?php if($page_name == 'define-availibity') { echo 'active';} ?>"> <a class="nav-link" href="<?php echo esc_url(get_the_permalink());?>?ext=define-availlibity"> <?php echo esc_html__( 'Define Your Availibity', 'exertio_theme' ); ?> 
					</a></li>
						<li class="nav-item <?php if($page_name == 'meeting-manage') { echo 'active';} ?>"> <a class="nav-link" href="<?php echo esc_url(get_the_permalink());?>?ext=meeting-manage"> <?php echo esc_html__( 'Manage Existing Meeting', 'exertio_theme' ); ?> 
					</a></li>
					  </ul>
					</div>
            ...
            if($key == 'MyRatings' && $val != "")
            {
                ...
                <li class="nav-item <?php if($page_name == 'my-ratings') { echo 'active';} ?>">
                    <a class="nav-link" href="<?php echo esc_url(get_the_permalink());?>?ext=my-ratings">
