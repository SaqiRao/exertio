				...
				<div class="col-xl-8 col-lg-12 col-md-12 grid-margin stretch-card">
					...
					<form id="project_form" >
					  ...
					  <div class="card mb-4">
                       ...
                       <?php if(fl_framework_get_options('project_attachements') == 2)
                        {
					  ...
					  <?php $pro_img_id = get_post_meta( $pid, '_project_attachment_ids', true ); ?>
						<div class="card-body project-attachments">
						  	...
						  	<div class="form-row">
								<div class="form-group col-md-12"> 
									<label> <?php echo esc_html__('Enable Tickets on This Event?','dwt-listing'); ?></label> 
							...
							<div class="form-row img-wrapper" <?php echo esc_attr($display); ?>>
								<div class="form-group col-md-12">
									<div class="upload-btn-wrapper">
										<button class="btn btn-theme-secondary mt-2 mt-xl-0" type="button"><?php echo esc_html__('Upload attachments','dwt-listing'); ?></button>
							...
							<div class="form-row" >
												...
												$icon = get_icon_for_attachment($value);
													...
													echo '<div class="attachments ui-state-default  pro-atta-'.$value.'">
															...
															<span class="attachment-data">
																<h4>'.$filename.'</h4>
																<p>'.esc_html__('file size','dwt-listing').' '.size_format(filesize(get_attached_file( $value ))).'</p>
								...
								<p class="attachment_note"><?php echo esc_html__('Drag & drop to rearrange and press save button to apply.','dwt-listing'); ?></p>
							</div>
