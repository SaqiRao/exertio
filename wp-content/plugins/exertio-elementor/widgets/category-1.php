...
class Category_One extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
         ...
         $this->add_control(
			'carousel_autoplay',
			[
				'label' => __( 'Slider autoplay', 'exertio-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'yes',
				'label_block' =>true,
				'options' => [
			...
			'autoplay_time',
			[
				'label' => __( 'Slider autoplay time', 'exertio-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '3000',
				'label_block' =>true,
				'options' => [
					'1000'  => __( '1 Sec', 'exertio-elementor' ),
					'2000'  => __( '2 Sec', 'exertio-elementor' ),
					'3000'  => __( '3 Sec', 'exertio-elementor' ),
					'4000'  => __( '4 Sec', 'exertio-elementor' ),
					'5000'  => __( '5 Sec', 'exertio-elementor' ),
        ...
        $params['carousel_autoplay']   =   $settings['carousel_autoplay'];
         $params['autoplay_time']   =   $settings['autoplay_time'];
 ...
 var $auto_play = false;
 var $is_$auto_play   =  jQuery('#cat-slider-autoplay').val();

  if($is_$auto_play == 'yes'){
  	$auto_play  = true;
  }
   var $autoplay_time =  jQuery('#autoplay_time').val();
  if($autoplay_time == ""){
  	$autoplay_time =  3000;
  }
