		...
		function exertio_freelancer_order_status_completed( $order_id )
		{
			...
			foreach ( $items as $item )
			{
				...
				if($prduct_type == 'freelancer-packages') 
				{
					...
					{
						$featured_services = (int)$ext_featured_services + (int)$featured_services;
					}
					...
					{
						$featured_services_expiry = (int)$ext_featured_services_expiry + (int)$featured_services_expiry;
					}
					...
					{
						$freelancer_package_expiry = (int)$ext_freelancer_package_expiry + (int)$freelancer_package_expiry;
					}
